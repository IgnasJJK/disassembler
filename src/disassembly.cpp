...
enum Inst_1Byte
{
    ...
    INST_MOVSB = 0b10100100,
    INST_MOVSW = 0b10100101,
    INST_CMPSB = 0b10100110,
    INST_CMPSW = 0b10100111,
    INST_SCASB = 0b10101110,
    INST_SCASW = 0b10101111,
    INST_LODSB = 0b10101100,
    INST_LODSW = 0b10101101,
    INST_STOSB = 0b10101010,
    INST_STOSW = 0b10101011,
